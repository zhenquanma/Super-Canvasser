...
export declare abstract class Layer {
     ...
     * @abstract
     */
    abstract AddEntity(entity: Marker | InfoWindow | Polygon | Polyline): void;
    /**
     ...
     * @abstract
     */
    abstract AddEntities(entity: Array<Marker | InfoWindow | Polygon | Polyline>): void;
    /**
     * Deletes the layer.
     *
     * @memberof Layer
     ...
     * @abstract
     */
    abstract GetOptions(): ILayerOptions;
    /**
    ...
    * @abstract
    */
    abstract RemoveEntity(entity: Marker | InfoWindow | Polygon | Polyline): void;
    /**
    ...
    * @abstract
    */
    abstract SetEntities(entities: Array<Marker> | Array<InfoWindow> | Array<Polygon> | Array<Polyline>): void;
    /**
     ...
     * @abstract
     */
    abstract SetOptions(options: ILayerOptions): void;
    /**
