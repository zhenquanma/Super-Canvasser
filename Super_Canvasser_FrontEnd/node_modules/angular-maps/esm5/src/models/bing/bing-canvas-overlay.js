    ...
    function () {
        ...
        this._viewChangeEvent = Microsoft.Maps.Events.addHandler(map, 'viewchange', function (e) {
            if (map.getMapTypeId() === Microsoft.Maps.MapTypeId.streetside) {
                ...
                var /** @type {?} */ pixelPoints = /** @type {?} */ (map.tryLocationToPixel([
